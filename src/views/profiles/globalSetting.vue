		...
		<pt-row>
			<pt-col :span="6">
				<div class="nav-tree-container">
					<pt-tree :treeData="navList" dataKey="name" @tree-node-select="handleNavToSection" />
				</div>
			</pt-col>
			<pt-col :span="18">
				...
				<div class="operator-container">
					<pt-button type="primary" className="btn-save" @click="handleSaveClick">
...
export default {
	...
	methods: {
		updateSessionConfig() {
			console.log('保存的数据', this.profileData)
