		...
		<div class='n-setting-content'>
			<el-scrollbar>
						...
						<el-row :gutter='40' style='margin-bottom: 20px'>
							...
							<el-col :span='16'>
								<el-select v-model='settingsForm[fontFamilyList.name]' @change='handlerSettingChange'>
									<el-option
										v-for='(item, index) in fontFamilyList.options'
										:label='$t(item.label)'
										:value='item.value'
										:key='index'
									/>
				...
				<el-row :gutter='40'>
					<el-col :xs='24' :sm='24' :md='24' :lg='12' :xl='12'>
						<el-row :gutter='40' style='margin-bottom: 20px'>
							<el-col :span='8' class='n-setting-content__label'>开启鼠标选中复制</el-col>
							<el-col :span='16'>
								<el-switch v-model='settingsForm.selectedCopy'
										   @change='handlerSettingChange'></el-switch>
							</el-col>
						</el-row>
					</el-col>
				</el-row>
