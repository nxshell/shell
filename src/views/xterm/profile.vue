<template>
	<div class="pt-shell-profile" @keydown.enter="doOK">
		<el-tabs tab-position="left">
			<el-tab-pane :label="T('home.profile.base.title')">
				<pt-profile-view
					v-model="profileData"
					:settingConfig="profiles[0]"
					:simple="true"/>
			</el-tab-pane>
			<el-tab-pane :label="T('home.profile.auth.title')">
				<pt-profile-view
					v-model="profileData"
					:settingConfig="profiles[1]"
					:simple="true" />
			</el-tab-pane>
			<el-tab-pane :label="T('home.profile.connect.title')">
				<pt-profile-view
					v-model="profileData"
					:settingConfig="profiles[2]"
					:simple="true" />
			</el-tab-pane>
			<el-tab-pane :label="T('home.profile.terminal.title')">
				<pt-profile-view
					v-model="profileData"
					:settingConfig="profiles[3]"
					:simple="true" />
			</el-tab-pane>
		</el-tabs>
	</div>
