<template>
	<div class="pt-vnc-view">
		<pt-toolbar :height="40">
			<pt-icon iconName="copy" slot="left" size="medium" :title="T('home.session-instance.ctrldelete')" flat
			         @click="sendCtrlAltDel" />
			<pt-icon iconName="refresh" slot="left" size="medium" :title="T('home.session-instance.reconnect')" flat
			         @click="reconnect" />
			<pt-inputbox type="text"
			             ...
			             slot="center"
			/>
			<pt-icon type="img" :iconName="shutdownIcon" slot="right" size="medium"
			         :title="T('home.session-instance.shutdown')" flat @click="shutdown" />
		</pt-toolbar>
