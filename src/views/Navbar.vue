<template>
	<div class="pt-shell-app-nav-bar">
		<div class="pt-logo" :class="{ macos: IS_MACOS }">
			<el-avatar shape="square" fit="fill" size="small" :src="require('@/assets/logo.png')" @click.native="doConfig" />
		</div>
		...
		<div class="icon-setting-container">
			<Space vertical align="center">
				...
				<!-- 主题切换按钮 -->
				<el-button type="text" :icon="themeIcon" @click="toggleTheme"></el-button>
				<!-- 设置按钮 -->
